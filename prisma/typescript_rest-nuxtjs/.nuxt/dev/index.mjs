globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file://C:/dev/projects/prisma/typescript_rest-nuxtjs/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseStatus, getRequestHeader, setResponseHeader, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, readBody, getQuery as getQuery$1, createError } from 'file://C:/dev/projects/prisma/typescript_rest-nuxtjs/node_modules/h3/dist/index.mjs';
import { PrismaClient } from 'file://C:/dev/projects/prisma/typescript_rest-nuxtjs/node_modules/@prisma/client/index.js';
import { createRenderer } from 'file://C:/dev/projects/prisma/typescript_rest-nuxtjs/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://C:/dev/projects/prisma/typescript_rest-nuxtjs/node_modules/devalue/index.js';
import { renderToString } from 'file://C:/dev/projects/prisma/typescript_rest-nuxtjs/node_modules/vue/server-renderer/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file://C:/dev/projects/prisma/typescript_rest-nuxtjs/node_modules/ofetch/dist/node.mjs';
import destr from 'file://C:/dev/projects/prisma/typescript_rest-nuxtjs/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file://C:/dev/projects/prisma/typescript_rest-nuxtjs/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://C:/dev/projects/prisma/typescript_rest-nuxtjs/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file://C:/dev/projects/prisma/typescript_rest-nuxtjs/node_modules/scule/dist/index.mjs';
import { klona } from 'file://C:/dev/projects/prisma/typescript_rest-nuxtjs/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://C:/dev/projects/prisma/typescript_rest-nuxtjs/node_modules/defu/dist/defu.mjs';
import { hash } from 'file://C:/dev/projects/prisma/typescript_rest-nuxtjs/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file://C:/dev/projects/prisma/typescript_rest-nuxtjs/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://C:/dev/projects/prisma/typescript_rest-nuxtjs/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://C:/dev/projects/prisma/typescript_rest-nuxtjs/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://C:/dev/projects/prisma/typescript_rest-nuxtjs/node_modules/radix3/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"C:/dev/projects/prisma/typescript_rest-nuxtjs/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\dev\\projects\\prisma\\typescript_rest-nuxtjs","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\dev\\projects\\prisma\\typescript_rest-nuxtjs\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\dev\\projects\\prisma\\typescript_rest-nuxtjs\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\dev\\projects\\prisma\\typescript_rest-nuxtjs\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _lazy_c7xReM = () => Promise.resolve().then(function () { return author$1; });
const _lazy_IHIOh6 = () => Promise.resolve().then(function () { return draftList_get$1; });
const _lazy_kOQr5k = () => Promise.resolve().then(function () { return feed_get$1; });
const _lazy_9tROAC = () => Promise.resolve().then(function () { return filterPosts_get$1; });
const _lazy_tUvZjp = () => Promise.resolve().then(function () { return _id__delete$1; });
const _lazy_dRsJV3 = () => Promise.resolve().then(function () { return _id__get$1; });
const _lazy_0av7Fj = () => Promise.resolve().then(function () { return index$1; });
const _lazy_X0VeSN = () => Promise.resolve().then(function () { return _id__put$1; });
const _lazy_P0jkje = () => Promise.resolve().then(function () { return user$1; });
const _lazy_X5y7mT = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/author', handler: _lazy_c7xReM, lazy: true, middleware: false, method: undefined },
  { route: '/draft-list', handler: _lazy_IHIOh6, lazy: true, middleware: false, method: "get" },
  { route: '/feed', handler: _lazy_kOQr5k, lazy: true, middleware: false, method: "get" },
  { route: '/filterPosts', handler: _lazy_9tROAC, lazy: true, middleware: false, method: "get" },
  { route: '/post/:id', handler: _lazy_tUvZjp, lazy: true, middleware: false, method: "delete" },
  { route: '/post/:id', handler: _lazy_dRsJV3, lazy: true, middleware: false, method: "get" },
  { route: '/post', handler: _lazy_0av7Fj, lazy: true, middleware: false, method: undefined },
  { route: '/publish/:id', handler: _lazy_X0VeSN, lazy: true, middleware: false, method: "put" },
  { route: '/user', handler: _lazy_P0jkje, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_X5y7mT, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_X5y7mT, lazy: true, middleware: false, method: undefined }
];
...
const author = eventHandler(async (event) => {
...
const getClientManifest = () => import('file://C:/dev/projects/prisma/typescript_rest-nuxtjs/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('file://C:/dev/projects/prisma/typescript_rest-nuxtjs/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
